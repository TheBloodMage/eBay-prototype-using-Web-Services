...
//app.get('/getAllProducts'		, web_services.getAllProducts);
app.get('/managesellitems'		, home.managesellitems);
//app.get('/managesellitems'	, web_services.managesellitems);
app.get('/managebiditems'		, home.managebiditems);
//app.get('/managebiditems'		, web_services.managebiditems);
app.get('/yourCart'				, home.yourCart);
//app.get('/yourCart'			, web_services.yourCart);
app.get('/getAllBids'			, home.getAllBids);
//app.get('/getAllBids'			, web_services.getAllBids);
app.get('/boughthistory'		, home.boughthistory);
//app.get('/boughthistory'		, web_services.boughthistory);
app.get('/soldhistory'			, home.soldhistory);
//app.get('/soldhistory'		, web_services.soldhistory);
...
//app.post('/money'				, web_services.money);
